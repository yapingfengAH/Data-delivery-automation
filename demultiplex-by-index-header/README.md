...
**Note** <br>
For email notification, please change the default email address to your own email address in the main.sh script (line 10). <br>
...
Create a samplesheet from the template.  Note that columns Samples ID, Index (i7), and Index2 (i5) are needed for the script.  Lane column corresponds to the lane's undetermined reads.  This samplesheet shows dual indexes with nucleotide length of 8 each.
